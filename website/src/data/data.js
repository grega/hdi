...
MIT`,
    modes: {
      default: [
        ...
        {
          type: "command",
          text: "docker push ghcr.io/acme/express-api:latest",
        },
      ],
      install: [
        { type: "header", text: "Prerequisites" },
    ...
    check: [
      ...
      { tool: "npm", installed: true, version: "11.11.1" },
      { tool: "npx", installed: true, version: "11.11.1" },
      { tool: "docker", installed: true, version: "29.3.1" },
    ],
    fullProse: {
      default: [
        { type: "header", text: "Prerequisites" },
        ...
        {
          type: "prose",
          text: "Requires Node.js 20+ and a running PostgreSQL instance.",
        },
        { type: "empty", text: "" },
        { type: "command", text: "nvm install 20" },
        { type: "command", text: "nvm use 20" },
        ...
        {
          type: "prose",
          text: "Start the development server with hot reload:",
        },
        { type: "empty", text: "" },
        { type: "command", text: "npm run dev" },
        { type: "empty", text: "" },
        {
          type: "prose",
          text: "The API will be available at `http://localhost:4000/api`.",
        },
        { type: "empty", text: "" },
        { type: "header", text: "Testing" },
        { type: "empty", text: "" },
        ...
        {
          type: "prose",
          text: "Build the Docker image and push to the container registry:",
        },
        { type: "empty", text: "" },
        { type: "command", text: "docker build -t express-api ." },
        {
...
MIT`,
    modes: {
      default: [
        ...
        {
          type: "command",
          text: "docker push registry.example.com/flask-app:latest",
        },
    ...
    check: [
      { tool: "python3", installed: true, version: "3.9.6" },
      { tool: "pip", installed: false },
      { tool: "flask", installed: false },
      { tool: "pytest", installed: false },
      { tool: "docker", installed: true, version: "29.3.1" },
    ],
    fullProse: {
      default: [
        ...
        {
          type: "prose",
          text: "The app will be available at `http://localhost:5000`.",
        },
        { type: "empty", text: "" },
        { type: "header", text: "Testing" },
        { type: "empty", text: "" },
...
MIT`,
    modes: {
      default: [
        ...
        {
          type: "command",
          text: "bundle exec rspec spec/models/project_spec.rb",
        },
        { type: "header", text: "Deployment" },
    ...
    check: [
      { tool: "brew", installed: true, version: "5.1.2" },
      { tool: "bundle", installed: true, version: "1.17.2" },
    ...
    fullProse: {
      default: [
        ...
        {
          type: "prose",
          text: "Or start all processes (web, worker, CSS watcher) with Foreman:",
        },
        { type: "empty", text: "" },
        { type: "command", text: "bin/dev" },
        { type: "empty", text: "" },
        {
          type: "prose",
          text: "The app will be available at `http://localhost:3000`.",
        },
        { type: "empty", text: "" },
        { type: "header", text: "Testing" },
        { type: "empty", text: "" },
...
See the [Next.js docs](https://nextjs.org/docs).`,
    ...
    fullProse: {
      default: [
        ...
        {
          type: "prose",
          text: "Copy the environment file and configure your database connection:",
        },
        { type: "empty", text: "" },
        { type: "command", text: "cp .env.example .env.local" },
        { type: "empty", text: "" },
        ...
        {
          type: "prose",
          text: "Open [http://localhost:3000](http://localhost:3000) with your browser.",
        },
        { type: "empty", text: "" },
        { type: "header", text: "Testing" },
        { type: "empty", text: "" },
...
\`\`\``,
    modes: {
      default: [
        ...
        {
          type: "command",
          text: "go test -race -coverprofile=coverage.out ./...",
        },
        { type: "header", text: "Deployment" },
    ...
    fullProse: {
      default: [
        ...
        {
          type: "prose",
          text: "Build the container image and push to the registry:",
        },
        { type: "empty", text: "" },
        { type: "command", text: "docker build -t go-service ." },
        { type: "command", text: "docker push ghcr.io/acme/go-service:latest" },
...
export const HELP_TEXT = `hdi - "How do I..." - Extracts setup/run/test commands from a README.
